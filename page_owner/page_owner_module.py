...
def process_file(file_path):
    ...
    print("{:>10} {:>10} {:>10} {:>10}".format("Count", "Pages", "Kbytes", "Module"))
    sorted_allocations = sorted(allocations.items(), key=lambda x: x[1]["pages"] * 4, reverse=True)
    for module, data in sorted_allocations:
        print("{:>10} {:>10} {:>10} {:<10}".format(data["count"], data["pages"], data["pages"] * 4, module))
